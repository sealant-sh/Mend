...
(https://github.com/Yash-Singh1/ghostty/tree/custom-io). Set the directory to the cloned repository
checked out on the `custom-io` branch to `GHOSTTY_SOURCE_DIR`.
