// Mend: isMacPlatform inlined from t3's lib/utils (the only import from it).
...
import { isMonospaceFamily } from "./monospace-probe";
import {
  measureGhosttyCell,
...
export class GhosttyTerminalSurface {
  ...
  // Mend: widened to Uint8Array — our transport is binary WebSocket frames
  // (the core already accepts bytes; t3's transport delivered strings).
